...
public class FourSquare extends AppCompatActivity {
    ...
    private void desciribing(){
        ...
        timeText1 = findViewById(R.id.timeText2);
        scoreText1 = findViewById(R.id.scoreText2);
        ...
        imageViewsArray = new ImageView[] {image1 , image2 , image3 , image4 , image5 , image6 , image7 , image8
    ...
    private void startGame(){
        new CountDownTimer(10000,1000){
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(FourSquare.this);
                ...
                alert.setNegativeButton("No", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(FourSquare.this , MainActivity.class);
                        finish();
                        startActivity(intent);
                    }
                });
